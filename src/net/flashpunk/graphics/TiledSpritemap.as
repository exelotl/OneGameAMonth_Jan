package net.flashpunk.graphics 
{
	...
	public class TiledSpritemap extends Spritemap
	{
		...
		// Modification thanks to nastySprite ( http://flashpunk.net/forums/index.php?topic=4463.msg27943#msg27943 )
		
		public function setWidth(value:uint):void
		{
			if (_imageWidth == value) return;
			_imageWidth = value;
			if (_imageWidth > _buffer.width)
				createBuffer();
			updateBuffer();
		}
		...
		public function setHeight(value:uint):void
		{
			...
			_imageHeight = value;
			if (_imageHeight > _buffer.height)
				createBuffer();
			updateBuffer();
		}
